...
export default function Footer() {
    return (
        <footer className=" dark:bg-gray-900 text-secondary-foreground dark:text-gray-100 pt-16 pb-8 transition-colors">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center gap-4 pt-4">
                            <a href="https://www.facebook.com/Zapurse/" className="p-2 bg-white dark:bg-gray-800 rounded-full shadow-sm hover:text-primary transition-colors"><Facebook size={18} /></a>
                            <a href="https://www.instagram.com/zapurse_recharge/" className="p-2 bg-white dark:bg-gray-800 rounded-full shadow-sm hover:text-primary transition-colors"><Instagram size={18} /></a>
                            <a href="https://www.linkedin.com/showcase/zapurse" className="p-2 bg-white dark:bg-gray-800 rounded-full shadow-sm hover:text-primary transition-colors"><Linkedin size={18} /></a>
                        </div>
                    </div>
